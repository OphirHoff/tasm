...
IsBomb = 10
speed = 2
FruitsNum = 2 ; number of fruits exist in DS
offsetsDifference = 14
STACK 100h
DATASEG
; --------------------------
...
mov si, 0
mov [pri1+BmpOffsetOnDs], offset bananaPic
